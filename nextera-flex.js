...
var path = "C:/VWorks Workspace/Protocol Files/nextera-flex/";
var form = "nextera-flex.VWForm";

run("C:/VWorks Workspace/Protocol Files/nextera-flex/resources/clear_inventory.bat", true);
...
protocols["Size selection"] = {
	file: "nextera-flex_double-spri.pro",
	settings: {
		sampleVolume: 45,
		beadVolume1: 42.5,
		beadVolume2: 15,
